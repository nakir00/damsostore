...
<div class="relative"
    ...
    "
     >
        ...
        <div class=" z-40 absolute -right-28  bottom-0 mb-16 w-screen max-w-xs px-6 py-8 mx-auto bg-white border border-gray-100 shadow-xl rounded-xl"
        x-show="linesVisible"
                            ...
                            <div class="flow-root" >
                                <ul class="-my-4 overflow-y-auto divide-y divide-gray-100 max-h-72">
                                    @foreach ($cart['lines'] as $index => $line)
                                        <li>
                                            <div class="grid grid-cols-4"  wire:key="line_{{ $line['slug'] }}">
                                                ...
                                                <div class=" col-span-3 flex-1 ml-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex justify-start items-center mt-2">
                                                                ...
                                                                <button class="p-2 ml-8 text-gray-600 transition-colors rounded-lg hover:bg-red-100 hover:text-red-700"
                                                                        type="button"
                                                                        @if(is_null($line['handle']))
